 ...
 */
public class MyArrayAdapterEle extends ArrayAdapter<String> {
    private final Context context;
    private final List<String> values, values1, values2, values3;
    private final HashMap<String, Integer> mIdMap, mIdMap1;
    public MyArrayAdapterEle(Context context, List<String> value, List<String> value1, List<String> value2, List<String> value3) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView.setText(values.get(position)+" "+values1.get(position));
        textView1.setText(values2.get(position)+" "+values3.get(position));
